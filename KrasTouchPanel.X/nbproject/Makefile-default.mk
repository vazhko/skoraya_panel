...
${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1: ../lib/mTouchCap/mTouchAcquistion.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=32 --float=32 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DOW_USE_CHANGING_BIT -DUSE_EE_DATA -DUSE_RS485 -P -N255 -I".." -I"../.." -I"../../lib/include" -I"../../lib/mTouchCap/include" -I"../../lib/oss" -I"../lib/include" -I"../lib/mTouchCap/include" -I"../lib/oss" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"." --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1  ../lib/mTouchCap/mTouchAcquistion.c 
...
${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1: ../lib/mTouchCap/mTouchAcquistion.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=32 --float=32 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DOW_USE_CHANGING_BIT -DUSE_EE_DATA -DUSE_RS485 -P -N255 -I".." -I"../.." -I"../../lib/include" -I"../../lib/mTouchCap/include" -I"../../lib/oss" -I"../lib/include" -I"../lib/mTouchCap/include" -I"../lib/oss" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"." --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1  ../lib/mTouchCap/mTouchAcquistion.c 
	@-${MV} ${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.d ${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1179987321/mTouchAcquistion.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=32 --float=32 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DOW_USE_CHANGING_BIT -DUSE_EE_DATA -DUSE_RS485 -P -N255 -I".." -I"../.." -I"../../lib/include" -I"../../lib/mTouchCap/include" -I"../../lib/oss" -I"../lib/include" -I"../lib/mTouchCap/include" -I"../lib/oss" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"." --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.map  --double=32 --float=32 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DOW_USE_CHANGING_BIT -DUSE_EE_DATA -DUSE_RS485 -P -N255 -I".." -I"../.." -I"../../lib/include" -I"../../lib/mTouchCap/include" -I"../../lib/oss" -I"../lib/include" -I"../lib/mTouchCap/include" -I"../lib/oss" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"." --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/KrasTouchPanel.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
